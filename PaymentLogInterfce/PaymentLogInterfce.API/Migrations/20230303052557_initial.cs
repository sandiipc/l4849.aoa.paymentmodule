    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Owners_Roles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Owners_Roles_Owners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Owners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Owners_Roles_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Owners_Roles_OwnerId",
                table: "Owners_Roles",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Owners_Roles_RoleId",
                table: "Owners_Roles",
                column: "RoleId");
